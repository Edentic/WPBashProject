...
//Home network
define('WP_HOME','http://192.168.1.103:8080/${project_name}');
define('WP_SITEURL','http://192.168.1.103:8080/${project_name}');

//Host only network
//define('WP_HOME','http://192.168.57.10/${project_name}');
//define('WP_SITEURL','http://192.168.57.10/${project_name}');
